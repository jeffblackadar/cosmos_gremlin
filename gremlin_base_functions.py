...
from gremlin_python.driver import client as cl, serializer, protocol
...
def connect():
    ...
    try:
        ...
        settings_path = "C:\\python\\settings\\"
  


        # The json file stores settings so we don't have it in the code.
        # The json file looks like this:
        # {
        # "CDB_YOUR_ENDPOINT":"graph-william-white (or yours)",
        # "CDB_YOUR_DATABASE":"graphdb (or yours)",
        # "CDB_YOUR_COLLECTION_OR_GRAPH":"Persons (or yours)",
        # "CDB_YOUR_PASSWORD":" --- the primary key ---"
        # }
        # cv.json contains the credentials for this program.
        settings_file = settings_path+'cosmosdb_settings.json'
        with open(settings_file, "r") as read_file:
            auth_data = json.load(read_file)
        cdb_your_endpoint=auth_data['CDB_YOUR_ENDPOINT']
        cdb_your_database=auth_data['CDB_YOUR_DATABASE']
        cdb_your_collection_or_graph=auth_data['CDB_YOUR_COLLECTION_OR_GRAPH']
        cdb_your_password=auth_data['CDB_YOUR_PASSWORD']

        client = cl.Client('wss://'+cdb_your_endpoint+'.gremlin.cosmosdb.azure.com:443/', 'g',
                           username="/dbs/"+cdb_your_database+"/colls/"+cdb_your_collection_or_graph,
                           password=cdb_your_password,
